...
type Service interface {
	...
	GetUserAccessToken(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *service) GetUserAccessToken(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Service.GetUserAccessToken", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ServiceHandler interface {
	...
	GetUserAccessToken(context.Context, *Request, *Response) error
}
...
func RegisterServiceHandler(s server.Server, hdlr ServiceHandler, opts ...server.HandlerOption) error {
	type service interface {
		...
		GetUserAccessToken(ctx context.Context, in *Request, out *Response) error
	}
	type Service struct {
		service
	}
...
func (h *serviceHandler) GetUserAccessToken(ctx context.Context, in *Request, out *Response) error {
	return h.ServiceHandler.GetUserAccessToken(ctx, in, out)
}
